...
customize_gnome_dock() {
  gsettings set org.gnome.shell favorite-apps "['google-chrome.desktop', 'sublime_text.desktop', 'gnome-terminal.desktop', 'nautilus.desktop', 'virtualbox.desktop', 'firefox.desktop']"
